    ...
    def __init__(self):
        ...
        self.agent = ChatAgent(
            ...
            instructions=(
                ...
                'CRITICAL: You MUST respond in JSON format with the following structure:\n'
                '{"status": "input_required" | "completed" | "error", "message": "your response message here"}\n\n'
                'Always use this exact JSON format in your responses. Do not include any text outside of this JSON structure.'
            ),
